# Treasury Yields API - Examples

This folder contains example code for using the Treasury Yields API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/treasuryyields',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/treasuryyields](https://docs.apiverve.com/ref/treasuryyields)
