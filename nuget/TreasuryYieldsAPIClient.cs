...
namespace APIVerve.API.TreasuryYields
{
    ...
    /// <summary>
    /// Client for the TreasuryYields API
    /// </summary>
    public class TreasuryYieldsAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/treasuryyields";
        ...
        public TreasuryYieldsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TreasuryYieldsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TreasuryYieldsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TreasuryYieldsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TreasuryYieldsQueryOptions options)
        {
        ...
        public ResponseObj Execute(TreasuryYieldsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TreasuryYieldsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TreasuryYieldsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TreasuryYieldsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TreasuryYieldsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TreasuryYieldsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TreasuryYieldsQueryOptions options)
        {
