...
```gradle
dependencies {
    implementation 'com.github.apiverve:treasuryyields-api:1.1.14'
}
```
...
```java
import com.apiverve.treasuryyields.TreasuryYieldsAPIClient;
import com.apiverve.treasuryyields.APIResponse;
import com.apiverve.treasuryyields.APIException;

// Initialize the client
TreasuryYieldsAPIClient client = new TreasuryYieldsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("date", "2024-01-15");
    parameters.put("type", "bonds");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/treasuryyields](https://docs.apiverve.com/ref/treasuryyields)
...
- **Documentation:** [https://docs.apiverve.com/ref/treasuryyields](https://docs.apiverve.com/ref/treasuryyields)
- **Issues:** [GitHub Issues](https://github.com/apiverve/treasuryyields-api/issues)
